...
const products = [
  ...
  { id: 3, name: "PTZ (Pan-Tilt-Zoom)", category: "security", price: "₦85,000", desc: "Remote motorized tracking designed for complete coverage.", image: "https://commons.wikimedia.org/wiki/Special:FilePath/PTZ_(Pan_Tilt_Zoom)_security_camera.jpg" },
  { id: 4, name: "Turret / Eyeball Camera", category: "security", price: "₦38,000", desc: "Flexible viewing angles engineered to eliminate IR lens glare.", image: "https://images.unsplash.com/photo-1523350518665-e177eea6988b?auto=format&fit=crop&w=600&q=80" },
  { id: 5, name: "Wireless / Wi-Fi Camera", category: "security", price: "₦28,000", desc: "Fast installation with zero video cabling required.", image: "https://images.unsplash.com/photo-1510849911856-cdc9335e5597?auto=format&fit=crop&w=600&q=80" },
  { id: 6, name: "Wired / PoE Camera", category: "security", price: "₦48,000", desc: "High-speed data and stable power delivery via single ethernet cable.", image: "https://images.unsplash.com/photo-1639242689301-1d51c12f595d?auto=format&fit=crop&w=600&q=80" },
  { id: 7, name: "Doorbell Camera", category: "security", price: "₦30,000", desc: "Smart door access monitoring with real-time two-way audio.", image: "https://images.unsplash.com/photo-1633194883650-df448a10d554?auto=format&fit=crop&w=600&q=80" },
  { id: 8, name: "Thermal Camera", category: "security", price: "₦150,000", desc: "Advanced heat-signature tracking functional in zero-light.", image: "https://commons.wikimedia.org/wiki/Special:FilePath/FLIR_IP_Camera.png" },
  { id: 9, name: "360° / Fisheye Camera", category: "security", price: "₦60,000", desc: "Panoramic single-camera coverage designed for open rooms.", image: "https://commons.wikimedia.org/wiki/Special:FilePath/Fisheye_photo.jpg" },
  { id: 10, name: "Covert / Hidden Camera", category: "security", price: "₦25,000", desc: "Discreet form factor designed for covert interior monitoring.", image: "https://images.unsplash.com/photo-1510511336377-1a9caa095849?auto=format&fit=crop&w=600&q=80" },

  // Solar Panels
  { id: 11, name: "Monocrystalline Panel", category: "solar", price: "₦110,000", desc: "Highest efficiency rating (~22%) optimized for smaller roof spaces.", image: "https://images.unsplash.com/photo-1723177548474-b58ada59986b?auto=format&fit=crop&w=600&q=80" },
